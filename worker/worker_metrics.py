"""Prometheus instrumentation for the Worker service."""
...
def record_sns_failure():
    """Count one failed Amazon SNS publish."""
    DEPENDENCY_FAILURES.labels(service=SERVICE, dependency=DEPENDENCY_SNS).inc()
